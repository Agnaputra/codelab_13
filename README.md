...
![alt text](store_data_agna/images/lab1/1.png)
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Flutter JSON Demo - Agna', // <--- Jawaban Question 1
      theme: ThemeData(
        primarySwatch: Colors.green,     // <--- Ubah warna sesuai selera
      ),
...
![alt text](store_data_agna/images/lab1/7.png)
...
![alt text](store_data_agna/images/lab1/8.png)

![alt text](store_data_agna/images/lab1/9.png)
...
![alt text](store_data_agna/images/lab2/2.png)
...
![alt text](store_data_agna/images/lab3/1.png)
...
![alt text](store_data_agna/images/lab4/1.png)


### Step 2: Install Dependencies
Run flutter pub get if your editor doesn't do it automatically.
![alt text](store_data_agna/images/lab4/2.png)
...
![alt text](store_data_agna/images/lab4/3.png)
...
![alt text](store_data_agna/images/lab4/4.gif)

## Practical 5: Access the filesystem with path_provider

### Step 1: Add Dependencies
Add package path_providervia Terminal.
![alt text](store_data_agna/images/lab5/1.png)
...
![alt text](store_data_agna/images/lab5/2.png)
...
![alt text](store_data_agna/images/lab6/1.png)
...
![alt text](store_data_agna/images/lab7/1.png)
...
![alt text](store_data_agna/images/lab7/2.png)

- Question 9
Capture your practical results in GIF format and attach them to the README.
Then do a commit with the message " W13: Answer to Question 9 ".

![alt text](store_data_agna/images/lab7/3.gif)